export interface ChainLightningRuntimeConfig {
    maxTargets: number;
    chainRange: number;
...
export function buildChainLightningRuntimeConfig(params: Partial<ChainLightningRuntimeConfig>): ChainLightningRuntimeConfig {
    return {
