...
import {
    buildElectricCornChainRuntimeConfig,
    ElectricCornChainRuntimeConfig,
} from './ElectricCornChainRuntimeConfig';
import {
    ElectricCornLightningRenderer,
    ElectricCornLightningVisualParams,
} from './ElectricCornLightningRenderer';
...
export class ElectricCornChainAttack extends AttackBase {
    ...
    private readonly lightningRenderer = new ElectricCornLightningRenderer();
    private activeScheduledHits: number = 0;
    private runtimeConfig: ElectricCornChainRuntimeConfig = buildElectricCornChainRuntimeConfig({});

    public configureChain(params: Partial<ElectricCornChainRuntimeConfig>): void {
        this.runtimeConfig = buildElectricCornChainRuntimeConfig({
